...
class PaymentView(APIView):
    ...
    def get(self,request):
        ...
        try:
            package=Package.objects.get(pk=package_id,is_enble=True)
    ...
    def post(self,request):
        ...
        try:
            payment=Payment.object.get(token=token)
        ...
        if st !=10:
            ...
            payment.save()
            return Response({'detail':'Payment Cancelled by user'},status=status.HTTP_400_BAD_REQUEST)
